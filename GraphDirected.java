...
/**
 * Class represented directed Graphs
 ...
 * However MST could be built as GraphDirected
 */
public class GraphDirected {
    ...
    //vertices in Graph
    public GraphDirected(int verticesAmount) {
    ...
    */
    public boolean setEdge (int headName, int neighborName, int weight) {
        ...
        Edge additionalEdge = new Edge(neighborIndex, weight);
        this.vertex[headIndex].add(additionalEdge);
        return true;
    }
    ...
    */
    public static GraphDirected buildGraph(int[][] data) {
        ...
        GraphDirected newGraph = new GraphDirected(newVertexList.size());
    ...
    */
    public static GraphDirected buildGraph(ArrayList<PrimElement> pe) {
        ArrayList<Integer> newVertexList = new ArrayList();
    ...
    */
    ...
    public static void main(String[] args) {
        ...
        GraphDirected testGraph = new GraphDirected();
        int[][] data = {
            {1, 2, 5}, 
            {1, 3, 4}, 
            {2, 3, 2}, 
        ...
        GraphDirected GraphMST = buildGraph(MST);
